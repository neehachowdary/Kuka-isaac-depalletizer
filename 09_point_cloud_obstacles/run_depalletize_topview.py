...
set_camera_view(eye=[1.3, -0.3, 5.0], target=[1.3, -0.3, 0.3], camera_prim_path="/OmniverseKit_Persp")
...
print("Basic pick-and-place complete! Window stays open - close manually.")
